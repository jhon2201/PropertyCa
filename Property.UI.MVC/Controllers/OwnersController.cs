...
namespace Property.UI.MVC.Controllers
{
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idOwner,name,address,photo,birthdate")] Owner owner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idOwner,name,address,photo,birthdate")] Owner owner)
        {
            if (id != owner.idOwner)
            {
                return NotFound();
